# Explorando o Banco de Dados MySQL

Vamos criar as queries para a tabela `aula`.

**Pré-requisito:** Assumimos que você já conectou ao cliente MySQL e selecionou o banco de dados (`USE nome_do_banco;`) onde a tabela `aula` será criada.
